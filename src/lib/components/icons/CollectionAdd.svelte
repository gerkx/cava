<script lang="ts">
    ...
    <svg 
        ...
        {...$$restProps}
    >
        <path d="M24.1 33.9A11.9 11.9 0 1036 22a11.9 11.9 0 00-11.9 11.9zm3.9-1.5a.5.5 0 01.5-.5H34v-5.5a.5.5 0 01.5-.5h3a.5.5 0 01.5.5v5.5h5.5a.5.5 0 01.5.5v3a.5.5 0 01-.5.5H38v5.5a.5.5 0 01-.5.5h-3a.5.5 0 01-.5-.5v-5.5h-5.5a.5.5 0 01-.5-.5z"/>
